      ...
      <div className="nav-content">
        ...
        {isMobile && (
          <>
            ...
            <button className="mobile-menu-btn col-xs-30 col-md-30"
              onClick={toggleMobileMenu}
              data-testid="mobile-menu-btn"
              style={{ zIndex: isMobileMenuOpen ? 1001 : 1000, backgroundColor: isMobileMenuOpen ? 'rgba(255, 255, 255, 0.05)' : 'rgba(255, 255, 255, 0.9)' }}>
